...
2. Start annotation:
   ```
   labelImg /Users/applemaair/Desktop/modi/modi_script/datasets/modi_300_final/images /Users/applemaair/Desktop/modi/modi_script/datasets/modi_300_final/labels
   ```

3. In LabelImg settings:
   - View > Auto Save Mode (recommended)
   - Press Ctrl+Y to switch to YOLO format
   - File > Change Save Dir > Select: /Users/applemaair/Desktop/modi/modi_script/datasets/modi_300_final/labels
...
1. Run the split creation script:
   ```
   python create_splits.py --dataset /Users/applemaair/Desktop/modi/modi_script/datasets/modi_300_final
   ```

2. Train the model:
   ```
   yolo detect train data=/Users/applemaair/Desktop/modi/modi_script/datasets/modi_300_final/modi_matra.yaml model=yolov8n.pt epochs=100
   ```
