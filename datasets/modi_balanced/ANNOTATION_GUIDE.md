...
2. Start annotation:
   ```
   labelImg /Users/applemaair/Desktop/modi/modi_script/datasets/modi_balanced/images /Users/applemaair/Desktop/modi/modi_script/datasets/modi_balanced/labels
   ```

3. In LabelImg settings:
   - View > Auto Save Mode (recommended)
   - Press Ctrl+Y to switch to YOLO format
   - File > Change Save Dir > Select: /Users/applemaair/Desktop/modi/modi_script/datasets/modi_balanced/labels
...
1. Run the split creation script:
   ```
   python create_splits.py --dataset /Users/applemaair/Desktop/modi/modi_script/datasets/modi_balanced
   ```

2. Train the model:
   ```
   yolo detect train data=/Users/applemaair/Desktop/modi/modi_script/datasets/modi_balanced/modi_matra.yaml model=yolov8n.pt epochs=100
   ```
